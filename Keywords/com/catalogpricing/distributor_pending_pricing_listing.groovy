...
public class distributor_pending_pricing_listing {
	String combi_type
	...
	@Keyword
	def distributor_listprice() {
		String listing_list_price=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_list_price_listing'),2).getText()
	...
	@Keyword
	def distributor_saleprice() {
		String listing_sale_price=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_sale_price_listing'),2).getText()
	...
	def distributor_margin() {
		String listing_margin=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_margin_listing'),2).getText()
	...
	@Keyword
	def distributor_discount() {
		String listing_discount=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_discount_listing'),2).getText()
	...
	@Keyword
	def distributor_purchaseprice() {
		String listing_purchase_price=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_purchase_price_listing'),2).getText()
	...
	@Keyword
	def distributor_distributorfee() {
		String listing_distributor_fee=WebUI.findWebElement(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Pricing/distributor_pending_distributor_fee_listing'),2).getText()
