...
double list_price=CustomKeywords.'com.catalogpricing.direct_pending_pricing_listing.direct_listprice'()
println("LIST PRICE ON FRONTEND LISTING : "+list_price)

double sale_price=CustomKeywords.'com.catalogpricing.direct_pending_pricing_listing.direct_saleprice'()
println("SALE PRICE ON FRONTEND LISTING : "+sale_price)

double margin=CustomKeywords.'com.catalogpricing.direct_pending_pricing_listing.direct_margin'()
println("MARGIN ON FRONTEND LISTING : "+margin)

double discount=CustomKeywords.'com.catalogpricing.direct_pending_pricing_listing.direct_discount'()
println("DISCOUNT ON FRONTEND LISTING : "+discount)

double purchase_price=CustomKeywords.'com.catalogpricing.direct_pending_pricing_listing.direct_purchaseprice'()
