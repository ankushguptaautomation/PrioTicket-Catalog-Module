...
WebUI.click(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/list_click_distributor'))

List<WebElement> count=WebUI.findWebElements(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_expand_list'),2)

for(int i=0;i<count.size();i++)
{
	String text = WebUI.findWebElements(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_expand_list'),2).get(i).getAttribute('id')
println(text)

WebUI.delay(5)

String listing_list_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_list_price_expand',['tps_value':text]))
...
String listing_sale_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_sale_price_expand',['tps_value':text]))
...
String listing_margin=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_margin_expand',['tps_value':text]))
...
String listing_discount=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_discount_price_expand',['tps_value':text]))
...
String listing_purchase_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Distributor Tile expand view/distributor_purchase_price_expand',['tps_value':text]))
...
float final_clc_db_list_price;
if(clc_list_price==null)
	{
		 final_clc_db_list_price = 0;
	}
	else
	{
		 final_clc_db_list_price=Float.parseFloat(clc_list_price);
	}
...
float final_clc_db_sale_price;
if(clc_sale_price==null)
	{
		 final_clc_db_sale_price = 0;
	}
	else
	{
		 final_clc_db_sale_price=Float.parseFloat(clc_sale_price);
	}
...
float final_clc_db_purchase_price;
if(clc_purchase_price==null)
	{
		 final_clc_db_purchase_price = 0;
	}
	else
	{
		 final_clc_db_purchase_price=Float.parseFloat(clc_purchase_price);
	}
...
float final_clc_db_discount;
if(clc_discount==null)
	{
		 final_clc_db_discount = 0;
	}
	else
	{
		 final_clc_db_discount=Float.parseFloat(clc_discount);
	}
...
double clc_margin_db=clc_sale_price_db-clc_purchase_price_db
println("DATABASE MARGIN IN CLC TABLE : "+clc_margin_db)

if (list_price==clc_list_price_db && sale_price==clc_sale_price_db && margin==clc_margin_db && discount==clc_discount_db && purchase_price==clc_purchase_price_db)
	{
