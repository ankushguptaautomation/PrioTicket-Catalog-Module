...
String listing_list_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Direct Tile expand view/direct_list_price_expand',['tps_value':text]))
...
String listing_sale_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Direct Tile expand view/direct_sale_price_expand',['tps_value':text]))
...
String listing_margin=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Direct Tile expand view/direct_margin_expand',['tps_value':text]))
...
String listing_discount=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Direct Tile expand view/direct_discount_price_expand',['tps_value':text]))
...
String listing_purchase_price=WebUI.getText(findTestObject('PrioTicket Catalog Objects/Catalog Pricing Objects/Pending Popup Pricing Objects/Direct Tile expand view/direct_purchase_price_expand',['tps_value':text]))
