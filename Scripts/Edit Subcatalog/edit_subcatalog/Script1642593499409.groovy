...
//						println("Direct Subcatalog name : "+eld.getText())
						...
						
					{
						...
						if(direct_subcatalog_delete_button=="Edit Catalog")
						{
							...
							WebUI.setText(findTestObject('PrioTicket Catalog Objects/Edit Subcatalog Objects/edit_catalog_name'), GlobalVariable.create_subcatalog_name)
							WebUI.setText(findTestObject('PrioTicket Catalog Objects/Edit Subcatalog Objects/edit_catalog_desc'), GlobalVariable.create_subcatalog_desc)
							
							WebUI.click(findTestObject('PrioTicket Catalog Objects/Edit Subcatalog Objects/update_subcatalog_button'))
...
//						println("Distributor Subcatalog name : "+eld.getText())
						...
						
					{
						...
						if(distributor_subcatalog_delete_button=="Edit Catalog")
						{
...
//						println("Reseller Subcatalog name : "+eld.getText())
						...
						if(reseller_subcatalog_delete_button=="Edit Catalog")
						{
