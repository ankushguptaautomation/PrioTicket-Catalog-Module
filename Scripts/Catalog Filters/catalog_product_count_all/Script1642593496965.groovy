...
WebUI.click(findTestObject('PrioTicket Catalog Objects/Catalog Filters Objects/catalog_all_button'))

//Count Active Products to verify if there is pagination and dropdown selector
int all_products=WebUI.findWebElements(findTestObject('PrioTicket Catalog Objects/Catalog Filters Objects/toggle_button_listing'),2).size()
println("No.of All Products:"+all_products)
