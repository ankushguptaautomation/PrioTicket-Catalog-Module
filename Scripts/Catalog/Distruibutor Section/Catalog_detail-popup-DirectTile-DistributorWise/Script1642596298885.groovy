...

{
...

        {
                ...
                for (int product_type_length = 1; product_type_length <= sizeoftps; product_type_length++) {
                        ...
                        def supplierprices_query2 = "SELECT ticket_gross_price as saleprice FROM ticket_level_commission where hotel_id = " + "'" + distributorid + "'" + " and ticketpriceschedule_id = " + "'" + tps_ids + "'" + " and resale_currency_level = '1'"
                        ...
                        if (CustomKeywords.
                                'com.katalon.plugin.keyword.connection.ResultSetKeywords.isEmptyResult'(queryfortlc) == true) {
                        ...
                        if (CustomKeywords.
                                ...
                                WebUI.callTestCase(findTestCase('Catalog/Case With Main and Sub Catalog/Catalog_detail-popup-QueryForTLC'), [: ], FailureHandling.CONTINUE_ON_FAILURE)
