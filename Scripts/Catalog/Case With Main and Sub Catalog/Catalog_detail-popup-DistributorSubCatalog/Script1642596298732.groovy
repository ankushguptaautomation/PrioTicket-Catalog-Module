...
WebElement direct_catalog_id = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/Catalog/CatalogTiles/CatalogTile', [('catalogtiles'): 'distributor_catalog']), 10)
...
int sizeofsubcatalog = WebUI.findWebElements(findTestObject('Object Repository/Catalog/SubCatalogs/ParamertizedSubCatalog - withoutIndex', [('tiletype'): 'distributor']), 2).size()
...
for (int m = 1; m <= sizeofsubcatalog; m++) {
        ...
        WebElement direct_sub_catalog_id = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/Catalog/SubCatalogs/ParamertizedSubCatalog', [('tiletype'): 'distributor', ('position'): m]), 10)
        ...
        WebUI.click(findTestObject('Object Repository/Catalog/SubCatalogs/ParamertizedSubCatalog', [('tiletype'): 'distributor', ('position'): m]))
